...
public class ProcDeclProc implements IProcDecl {
	...
	public ProcDeclProc(final Procedure proc, final Identifier ident, final IParamList paramList,
			final IGlobalGlobImps globalGlobImps, final IOptLocalCpsStoDecl optLocalCpsStoDecl, final Do aDo,
			final ICpsCmd cpsCmd, final EndProcedure endproc) {
		this.proc = proc;
		this.ident = ident;
